...
if __name__ == '__main__':
    ...
    # 加载网络参数
    #select_agent.load_model(actor_path=f'.//Net//select_agent_net//Actor//episode400.pth', critic_path=f'.//Net//select_agent_net//Critic//episode400.pth')
    #agv_agent.load_model(actor_path=f'.//Net//agv_agent_net//Actor//episode400.pth', critic_path=f'.//Net//agv_agent_net//Critic//episode400.pth')
    ...
    for episode in range(num_episodes):
        # with tqdm(total=int(max_steps//2000), desc='Iteration %d' % episode) as pbar:
            ...
            if (episode+1) % 50 == 0:
                ...
                save_fig('select_return_list', select_return_list)
                save_fig('agv_return_list', agv_return_list)
                ...
                save_fig('finish_goods_list', finish_goods_list)
